...
export default function DashboardPage() {
  ...
  return (
    <div className="flex w-full h-dvh overflow-hidden bg-slate-50 dark:bg-zinc-950 text-slate-900 dark:text-white font-sans selection:bg-amber-500/30">
      ...
      <div className="flex-1 flex flex-col h-full relative overflow-y-auto scroll-smooth custom-scrollbar z-10 min-w-0">
